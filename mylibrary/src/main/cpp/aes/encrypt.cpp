...
Java_com_example_mylibrary_AesUtils_string2Base64(JNIEnv *env, jobject thiz, jbyteArray buf) {
    char *str = NULL;
...
Java_com_example_mylibrary_AesUtils_base642Byte(JNIEnv *env, jobject thiz, jstring hex_string) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_mylibrary_AesUtils_encrypt(JNIEnv *env, jobject thiz, jstring src) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_mylibrary_AesUtils_decrypt(JNIEnv *env, jobject thiz, jstring encrypted) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_mylibrary_AesUtils_getAESKey(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF((const char *) AES_KEY);
}
extern "C"
JNIEXPORT void JNICALL
Java_com_example_mylibrary_AesUtils_setAESKey(JNIEnv *env, jobject thiz, jstring key) {
    //接收java层传过来的String
